...
<html>
  <head>
    ...
    <title>Thankyou - from Bybu</title>
              ...
              <div class="column is-7 login-form-wrapper">
                ...
                <div class="column is-12 field-box">
                  <div class="column is-7 is-offset-1">
                    <h1 class="login-heading">Welcome to Gamu.lk</h1>
                    ...
                    <form method="" action="">
                      <div class="field">
                        <p class="control has-icons-left has-icons-right">
                          <input class="input is-medium" type="email"  id="uname" placeholder="Email" value="" name="email" autofocus="" required>
...
function login(){
 ...
 if(uname=="shop@login.com" && pass=="admin123") {alert("success fully login");
  window.location.href = "http://balapitiya.store/admin/index1.php";}

...
<ul class="navbar-nav mr-auto">
        ...
        <div class="row" >
            ...
            <div class="col-md-4 text-center justify-content-center">
               ...
               $query_AccountDetails= "select *from orders where statuss!='Resived' and statuss!='Ready' and statuss!='Cansel'";
    ...
    echo'  <tr>
      ...
      <td> <button type="button" class="btn btn-primary" id='.$row_AccountDetails['id'].'  onclick="getid1(this.id)">VIEW ORDER</button></td>

...
<head>
    ...
    <title>Buy More - All Ready Orders</title>
...
<body>
    ...
    <div class="row" >
        ...
        <div class="col-md-6 text-center justify-content-center">
            <table class="table table-hover table-responsive">
               ...
               $query_AccountDetails= "select *from orders where statuss!='completed' and statuss!='Resived' and statuss!='Cansel'";
    ...
    <div class="modal fade" id="detailsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" onload="getid();">
        ...
        <div class="modal-content">
            ...
            <button type="button" class="btn btn-danger" onclick=" getidsss1();">Diliverd</button>

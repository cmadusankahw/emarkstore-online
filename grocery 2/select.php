    ...
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-primary">
      ...
      <div class="container-fluid text-center" style="padding-top:30px; width:80%">
        ...
        <div class="text-center" style="padding-top:15px;">
            <h3><b>වෙළද සැල තෝරන්න</b></h3>
           </div>
           <hr>

        <form id="shopSel" action="">
       
          <div class="form-group" style="padding-top:30px;">
            <b><label for="seltown">වෙළද සැල</label></b>
            <select class="form-control" id="seltown">
              <option value="town1">සැසෙල් ස්ටෝර්ස්-බලපිටිය</option>
              <option value"town2">පියසේන සුපර් දෙහිවල</option>
            </select>
          </div>
        </form>

        <div style="padding-top:25px;">
            <p><a class="btn btn-primary btn-lg"  role="button">ඉදිරියට යන්න &raquo;</a></p>
           </div>  
